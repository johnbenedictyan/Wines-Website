...
class CustomerDetailForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(Row(Column(HTML("""<h2 class="h3 mb-3 text-black font-heading-serif">Billing Details</h2>"""),
                                               Div(Div("country",
                                                   ...
                                                   Row(Column("first_name",
                                                       ...
                                                       Column("last_name",
                                                              css_class="col-md-6"),
                                                   css_class="form-group"),
                                                   Row(Column("address_1",
                                                              css_class="col-md-12"),
                                                       css_class="form-group"),
                                                   Div("address_2",
                                                       css_class="form-group"),
                                                   Row(Column("state_or_country",
                                                              css_class="col-md-6"),
                                                       Column("postal_code_or_zip",
                                                       css_class="col-md-6"),
                                                   css_class="form-group"),
                                                   Row(Column("email",
                                                              css_class="col-md-6"),
                                ...
                                """),
                                        ...
                                        """),
                                                               Div("account_username",
                                                                   css_class="form-group"),
                                                           Div("account_password_1",
                                                               css_class="form-group"),
                                                           Div("account_password_2",
                                                               css_class="form-group"),
                                                           css_class="py-2"),
                                                       css_class="collapse",
                                ...
                                <label for="c_ship_different_address" class="text-black" data-toggle="collapse"
                                 ...
                                 """),
                                                       Div(Div(Div("alt_country",
                                                                   css_class="form-group"),
                                                               Row(Column("alt_address_1",
                                                                          css_class="col-md-12"),
                                                                   css_class="form-group"),
                                                           Div("alt_address_2",
                                                               css_class="form-group"),
                                                           Row(Column("alt_state_or_country",
                                                                      css_class="col-md-6"),
                                                               Column("alt_postal_code_or_zip",
                                                                      css_class="col-md-6"),
                                                           css_class="form-group"),
                                                           css_class="py-2"),
                                                       css_class="collapse",
